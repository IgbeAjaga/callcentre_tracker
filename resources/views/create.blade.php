...
<div class="card mt-5">
  ...
  <div class="d-grid gap-2 d-md-flex justify-content-md-end">
    ...
    <form action="{{ route('outgoingcalls.store') }}" method="POST">
        ...
        <div class="mb-3">
            <label for="inputBranchthatcalled" class="form-label"><strong>Your Branch:</strong></label>
        ...
        <div class="mb-3">
    <label for="inputBranchcalled" class="form-label"><strong>Branch(es) You Called:</strong></label>
    <div id="inputBranchcalled" class="@error('branchcalled') is-invalid @enderror">
        <div class="form-check">
            <input class="form-check-input" type="checkbox" name="branchcalled[]" value="Asokoro" id="branchcalledAsokoro">
            <label class="form-check-label" for="branchcalledAsokoro">Asokoro</label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="checkbox" name="branchcalled[]" value="Gana" id="branchcalledGana">
            <label class="form-check-label" for="branchcalledGana">Gana</label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="checkbox" name="branchcalled[]" value="Gimbiya" id="branchcalledGimbiya">
            <label class="form-check-label" for="branchcalledGimbiya">Gimbiya</label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="checkbox" name="branchcalled[]" value="Gwarinpa 1" id="branchcalledGwarinpa1">
            <label class="form-check-label" for="branchcalledGwarinpa1">Gwarinpa 1</label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="checkbox" name="branchcalled[]" value="Gwarinpa 2" id="branchcalledGwarinpa2">
            <label class="form-check-label" for="branchcalledGwarinpa2">Gwarinpa 2</label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="checkbox" name="branchcalled[]" value="Gwarinpa 3" id="branchcalledGwarinpa3">
            <label class="form-check-label" for="branchcalledGwarinpa3">Gwarinpa 3</label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="checkbox" name="branchcalled[]" value="Guzape" id="branchcalledGuzape">
            <label class="form-check-label" for="branchcalledGuzape">Guzape</label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="checkbox" name="branchcalled[]" value="New Ademola" id="branchcalledNewAdemola">
            <label class="form-check-label" for="branchcalledNewAdemola">New Ademola</label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="checkbox" name="branchcalled[]" value="New Garki" id="branchcalledNewGarki">
            <label class="form-check-label" for="branchcalledNewGarki">New Garki</label>
        </div>
        
        <div class="form-check">
            <input class="form-check-input" type="checkbox" name="branchcalled[]" value="New Wuse" id="branchcalledNewWuse">
            <label class="form-check-label" for="branchcalledNewWuse">New Wuse</label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="checkbox" name="branchcalled[]" value="Old Ademola" id="branchcalledOldAdemola">
            <label class="form-check-label" for="branchcalledOldAdemola">Old Ademola</label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="checkbox" name="branchcalled[]" value="Omega" id="branchcalledOmega">
            <label class="form-check-label" for="branchcalledOmega">Omega</label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="checkbox" name="branchcalled[]" value="Wholesale" id="branchcalledWholesale">
